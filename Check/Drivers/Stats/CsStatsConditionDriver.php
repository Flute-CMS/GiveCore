...
/**
 * Драйвер условия: проверка статистики CsStats
 */
class CsStatsConditionDriver extends AbstractCheckDriver
{
    protected const MOD_KEY = 'CsStats';

    public function alias(): string
    {
        return 'csstats_stats';
    }

    public function name(): string
    {
        return __('givecore.drivers.csstats.name');
    }

    public function description(): string
    {
        return __('givecore.drivers.csstats.description');
    }
    ...
    public function check(User $user, array $params = []): bool
    {
        ...
        try {
            ...
            logs()->warning("RoleSync CsStats check failed for user {$user->id}: " . $e->getMessage());
