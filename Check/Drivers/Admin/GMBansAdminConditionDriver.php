...
class GMBansAdminConditionDriver extends AbstractCheckDriver
{
    ...
    {
        return __('givecore.drivers.gmbans_admin.name');
    }

    public function description(): string
    {
        return __('givecore.drivers.gmbans_admin.description');
    }
    ...
    public function check(User $user, array $params = []): bool
    {
        ...
        try {
            ...
            logs()->warning("RoleSync GMBans admin check failed for user {$user->id}: " . $e->getMessage());
